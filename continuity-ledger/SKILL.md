...
## Instructions
1. Gate the need for a ledger first. If a better durable artifact already exists and is current, reuse it instead of creating a second memory layer. When you do need a ledger, read `~/.codex/skills/continuity-ledger/references/template.md` for the minimal section set.
