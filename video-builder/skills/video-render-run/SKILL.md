...
2. Render with `~/.codex/skills/video-builder/scripts/render_video.py` using `python3 ~/.codex/skills/video-builder/scripts/render_video.py --spec /absolute/path/to/spec.json --out /absolute/path/to/out.mp4`.
