...
2. Recommend the smallest honest phone workflow that fits the request. If the user wants field-level guidance or the fuller operator pattern, read `~/.codex/skills/github-mobile-ops/references/mobile-control-surface.md`.
