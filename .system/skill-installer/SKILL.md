...
## Instructions
1. Choose the mode first: list curated skills, install a curated skill, or install from a GitHub repo/path. Use `~/.codex/skills/.system/skill-installer/scripts/list-skills.py` for listings and `~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py` for installs.
