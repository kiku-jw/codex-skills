...
2. Choose the smallest honest README shape for the repo type. Use `~/.codex/skills/readme-generator/references/section-matrix.md` when you need the section matrix. Add only the sections that materially reduce confusion.
