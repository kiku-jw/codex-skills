...
2. Build or update the plan, status, and test-plan files using the repo truth plus `~/.codex/skills/justdoit/references/plan-template.md`, `~/.codex/skills/justdoit/references/status-template.md`, and `~/.codex/skills/justdoit/references/test-plan-template.md` when you need the baseline structure. Keep milestones dependency-ordered and validation-first.
