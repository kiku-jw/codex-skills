...
## Instructions
1. Inspect the workbook first: target sheets, named ranges, formulas, styles, and the exact cells or structures that need to change. Use `openpyxl` and consult `~/.codex/skills/spreadsheet/references/examples/openpyxl` only when you need a concrete pattern.
