...
2. Run `/Users/nick/.codex/skills/transcribe/scripts/transcribe_diarize.py` with `gpt-4o-mini-transcribe` and plain text output under a stable output path such as `output/transcribe/`.
