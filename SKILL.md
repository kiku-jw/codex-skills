...
- If the finding changes architecture or product direction, say whether it deserves [$product-council](/Users/nick/.codex/skills/product-council/SKILL.md) or [$adr-log](/Users/nick/.codex/skills/adr-log/SKILL.md).
