...
## Instructions
1. Collect the real evidence first: diffs, issue notes, decisions, screenshots, metrics, or demo results. Then choose the artifact type. Read `~/.codex/skills/public-artifact-lane/references/artifact-types.md` for artifact selection and `~/.codex/skills/public-artifact-lane/references/storage.md` for default save locations only when needed.
