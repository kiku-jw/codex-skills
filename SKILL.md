...
## Instructions
1. Run the contract-clean gate first whenever the idea may touch client work, sensitive exports, ambiguous rights, shared accounts, or gray-source access. Use `/Users/nick/.codex/skills/idea-validation/references/contract-clean-gate.md` when you need the exact hard-reject surface.
