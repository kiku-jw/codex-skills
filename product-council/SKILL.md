...
2. Choose 3-5 lenses and run them on the same evidence base. Use `~/.codex/skills/product-council/references/roles.md` for role definitions and `~/.codex/skills/product-council/references/council-templates.md` when a named template fits the decision better than the default council.
