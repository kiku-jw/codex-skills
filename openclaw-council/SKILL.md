...
2. Run the isolated OpenClaw council pass, the contradiction-auditor pass, and the separate `codex exec` review. Use `~/.codex/skills/openclaw-council/references/prompt-pack.md` when you need the exact review prompts or setup details.
