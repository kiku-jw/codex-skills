...
## Instructions
1. Inspect the primary source first and fact-check the main claim. Use `~/.codex/skills/triage-finding/references/source-handling.md` when you need source-type handling rules.
...
3. Give exactly one primary verdict and the smallest useful next action. Use `~/.codex/skills/triage-finding/references/verdicts.md` only when you need the verdict frame.
